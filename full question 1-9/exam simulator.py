...
class QuizApp:
    def __init__(self, root, csv_file):
        ...
        # Adjust loop for 4 options (A to D)
        for i in range(4):  # Create only four checkboxes for options A to D
    ...
    def show_question(self):
        ...
        options = [question_data[f'Option {chr(65+i)}'] for i in range(4)]  # Adjust to collect only 4 options
        ...
        for i in range(len(options), 4):  # Adjust to manage only 4 checkboxes
